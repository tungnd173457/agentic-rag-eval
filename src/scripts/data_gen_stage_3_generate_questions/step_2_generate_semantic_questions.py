...
Args:
    --count  Number of questions to generate (default: 125)
...
STEP_OVERVIEW = """\
Similar to basic questions but steered toward challenging, loose-match queries.
Avoids keyword overlap and limits qualifiers so retrieval systems cannot rely
on lexical matching.
"""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=int,
        default=125,
        help="Number of questions to generate (default: 125)",
    )
    parser.add_argument(
        "--quiet",
        action="store_true",
    ...
    print(
        "\nThis step is complete, go on to step 3 to generate intra-document reasoning questions."
    )
